...
class EventService:
    ...
    def create(self, payload: EventCreate, organizer_id: UUID) -> Event:
        ...
        event = Event(
            ...
            featured_image_sm_url=payload.featured_image_sm_url,
            featured_image_md_url=payload.featured_image_md_url,
            featured_image_lg_url=payload.featured_image_lg_url,
